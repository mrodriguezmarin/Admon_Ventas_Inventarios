---
title: "Taller APYMSA Envases Plastico"
...
```{r}
ts.Envases=ts(Envases, frequency =12, start=c(1993,1), end = c(2019,12))
```
...
```{r}
Envases.train=window(ts.Envases, start=c(2003,1), end=c(2019,12))
plot(Envases.train)
```
...
```{r}
Envases.test=window(ts.Envases, start=c(2017,1), end=c(2019,12))
plot(Envases.test)
```
...
```{r}
plotarimapred(Envases.test,arima1,xlim=c(2017,2019), range.percent = 0.03, ylab = "Exportación de Envases",
